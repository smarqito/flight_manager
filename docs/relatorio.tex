...
\begin{landscape}
    \addsec{Anexo 5 - Diagrama de Classes do Booking Manager (Servidor)}
    \begin{figure}[!ht]
        \centering
...
\begin{landscape}
    \addsec{Anexo 6 - Diagrama de Classes do User Manager (Servidor)}
    \begin{figure}[!ht]
        \centering
...
\begin{landscape}
    \addsec{Anexo 7 - Diagrama Pseudo-Estado Menu de UI}
    \begin{figure}[!ht]
        \centering
